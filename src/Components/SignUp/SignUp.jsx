              ...
              <div className='bg-light bg-opacity-25 shadow-lg w-95 mx-auto p-5 rounded-2'>
                ...
                <div className='pt-3'>
                  <form onSubmit={handleSubmit}>
                    <input onChange={handleInputChange} className='form-control my-2' type="text" name='name' placeholder='Enter Your Name' />
                    ...
                    <input onChange={handleInputChange} className='form-control my-2' type="email" name='email' placeholder='Enter Your Email' />
                    ...
                    <input onChange={handleInputChange} className='form-control my-2' type="password" name='password' placeholder='Enter Your Password' />
                    ...
                    <input onChange={handleInputChange} className='form-control my-2' type="text" name='phone' placeholder='Enter Your Phone' />
